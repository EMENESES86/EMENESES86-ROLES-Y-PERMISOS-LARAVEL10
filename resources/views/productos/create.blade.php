...
@section('title')
    <title>Crear productos - ISUS</title>
                ...
                <div class="col-sm-12 col-md-12 col-lg-8">
                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Crear productos del sistema</h5>
                        </div>
                        <div class="card-body">

                            {!! Form::open(['route' => 'productos.store', 'enctype' => 'multipart/form-data', 'method' => 'POST']) !!}
                            @csrf
                            @include('productos.partial.crear')
