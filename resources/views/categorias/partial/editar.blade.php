    ...
    <div class="widget-user-header" style="background: url('<?php echo asset('dist/img/ISUS-fondo.png'); ?>')">
        <div class="row">
            ...
            <div id="preview" class="col-sm-12" align="center">
                ...
                @else
                    <img class="img-circle" src="<?php echo asset("storage/categorias/$cat->cat_avatar"); ?>" alt="User Avatar">
                @endif
            </div>
        </div>
...
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-8">
        ...
        <input class="form-control" type="text" name="cat_name" value="{{ $cat->cat_name }}" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4">
        <label>Color</label>
        <select class="form-control {{ $cat->cat_color }}" aria-label="Default select example" name="cat_color"
            required>
            <option selected value="{{ $cat->cat_color }}">{{ $cat->cat_color }}</option>
...
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12">
        ...
        <textarea class="form-control" name="cat_descripcion" id="" rows="5" onkeyup="countChars(this);" maxlength="150"
            required>{{ $cat->cat_descripcion }}</textarea>
